					...
					<div class="row mb-2">
						...
						<div class="col">
							...
							<span class="perfilPainelItemValor">
								<?= $this->view->todos_tweets['tota_tweet']?>
							</span>
						</div>
						...
						<div class="col">
							...
							<span class="perfilPainelItemValor">
								<?=$this->view->todos_seguindo['total_seguindo']?>
							</span>
						</div>
						...
						<div class="col">
							...
							<span class="perfilPainelItemValor">
								<?= $this->view->todos_seguidores['total_seguidores']?>
							</span>
						</div>
					...
					<div class="col">
						...
						<?php if ($tweet['id_usuario'] == $_SESSION['id']) : ?>
								<div class="col d-flex justify-content-end">
									<a href="/remove?id=<?=$tweet['id']?>" class="btn btn-danger">
										<small>Remover</small>
									</a>
								</div>
						<?php endif; ?>
